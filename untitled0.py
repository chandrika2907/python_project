...
Original file is located at
    https://colab.research.google.com/drive/1G0ztGwJMpUYbpMgqVre3DZG2XrHmrcN5
"""
...
def greeting_response(text):
   ...
   user_greetings=['hi','hello','whassup']
...
print('I am chatbot developed by chandrika to help you with the matters related to your health problems')
